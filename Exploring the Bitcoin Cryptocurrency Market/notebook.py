...
columns = ['id', 'market_cap_usd']
market_cap_raw = pd.DataFrame(dec6, columns = columns)
...
ax = cap10.plot(kind = 'bar', x = 'id',y='market_cap_perc', title = TOP_CAP_TITLE)
...
ax = cap10.plot(kind = 'bar',x='id',y='market_cap_usd',title=TOP_CAP_TITLE, color =COLORS, log=True)
